package com.example.ta.examresult;
...
public class ResultNews extends android.support.v4.app.ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.resultnews, container, false);
    ...
    class MyAsyncTask extends AsyncTask<Object,Void,ArrayAdapter>
    {
        ...
        {
            adapter = new ArrayAdapter(getActivity(), android.R.layout.simple_list_item_1, headlines);
